...
- **Year-wise Loan Approval** – Tracks loan approval trends over time.
- **Grade-wise Analysis** – Analyzes loans based on customer/loan grades.
- **Interactive Filters** – Enables users to filter the dashboard based on relevant dimensions.

### Credit & Debit Transaction Dashboard

- **Total Credit** – Displays the total amount credited.
- **Total Debit** – Displays the total amount debited.
- **Net Transaction** – Shows the difference between total credit and debit.
- **Credit-to-Debit Ratio** – Compares credit and debit transaction volumes.
- **Month-wise Transaction Analysis** – Tracks transaction activity over time.
- **Transaction Purpose Analysis** – Identifies major transaction purposes.
- **Transaction Method Analysis** – Compares Debit Card, Credit Card, and Bank Transfer transactions.
- **Branch-wise Transaction Analysis** – Compares transaction activity across branches.
- **Bank-wise Analysis** – Enables comparison of transaction activity across banks.
- **Date Filtering** – Allows users to analyze transactions for specific time periods.
- **Interactive Dashboard** – Provides dynamic filtering and visual exploration of transaction data.
